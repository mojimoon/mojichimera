...
import MojiMod.patches.relics.BottledPlaceholderField;
import MojiMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static MojiMod.MojiMod.makeRelicOutlinePath;
import static MojiMod.MojiMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = MojiMod.makeID("BottledPlaceholderRelic");
