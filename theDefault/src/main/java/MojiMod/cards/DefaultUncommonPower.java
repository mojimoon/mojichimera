...
import MojiMod.actions.UncommonPowerAction;
import MojiMod.characters.TheDefault;

import static MojiMod.MojiMod.makeCardPath;
...
public class DefaultUncommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = MojiMod.makeID(DefaultUncommonPower.class.getSimpleName());
