...
public class OverlookingMod extends AbstractAugment {
    public static final String ID = mojichimera.makeID(OverlookingMod.class.getSimpleName());
    ...
    @Override
    public AbstractCardModifier makeCopy() { return (AbstractCardModifier)new OverlookingMod(); }
