...
public class RecklessMod extends AbstractAugment {
    public static final String ID = mojichimera.makeID(RecklessMod.class.getSimpleName());
    ...
    @Override
    public AbstractCardModifier makeCopy() { return (AbstractCardModifier)new RecklessMod(); }
