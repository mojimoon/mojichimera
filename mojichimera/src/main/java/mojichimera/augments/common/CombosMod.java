...
public class CombosMod extends AbstractAugment {
    public static final String ID = mojichimera.makeID(CombosMod.class.getSimpleName());
    ...
    public void onUse(AbstractCard card, AbstractCreature target, UseCardAction action) {
        addToBot(new AbstractGameAction() {
            ...
            public void update() {
                ...
                if (lastCard != null && lastCard.type == AbstractCard.CardType.SKILL) {
    ...
    @Override
    public AbstractCardModifier makeCopy() { return (AbstractCardModifier)new CombosMod(); }
    ...
    private boolean shouldGlow(AbstractCard card) {
        ...
        return lastCard != null && lastCard.type == AbstractCard.CardType.SKILL;
    }

    public CardBorderGlowManager.GlowInfo getGlowInfo() {
        return new CardBorderGlowManager.GlowInfo() {
            public boolean test(AbstractCard card) {
                return CombosMod.this.hasThisMod(card) && CombosMod.this.shouldGlow(card);
            }
